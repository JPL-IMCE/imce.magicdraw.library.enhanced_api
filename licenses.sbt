...
val imce_md_enhanced_library_license =
...
headers := Map(
  "scala" -> (HeaderPattern.cStyleBlockComment, CommentBlock.cStyle(imce_md_enhanced_library_license)),
  "java"  -> (HeaderPattern.cStyleBlockComment, CommentBlock.cStyle(imce_md_enhanced_library_license)))
...
licenseConfigurations := Set("compile", "aspectj", "provided")
